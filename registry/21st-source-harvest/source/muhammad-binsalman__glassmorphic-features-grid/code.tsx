...
const Component: React.FC<InteractiveBentoGridProps> = ({
  textAutoHide = true,
  enableStars = true,
      ...
      <style>
        {`
          .bento-section {
            ...
            --background-glass: rgba(15, 23, 42, 0.6);
            --white: hsl(0, 0%, 100%);
          ...
          .card--border-glow:hover {
            box-shadow: 0 8px 32px rgba(59, 130, 246, 0.2), 0 0 40px rgba(${glowColor}, 0.15);
          }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-3">
          {cardData.map((card, index) => {
            const baseClassName = `card card-glass flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-6 rounded-2xl font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-1 ${
              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    <span className="card__label text-sm font-medium opacity-80 bg-white/10 px-3 py-1 rounded-full backdrop-blur-sm">
                      {card.label}
                    </span>
                  </div>
