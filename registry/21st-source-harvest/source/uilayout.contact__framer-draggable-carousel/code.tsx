...
export  function FramerDraggableCarousel() {
    ...
    <div className='w-full lg:p-10 sm:p-4 p-2 max-w-4xl mx-auto'>
      <div className='flex flex-col gap-3'>
        <div className='relative overflow-hidden rounded-lg' ref={containerRef}>
          ...
          {/* Progress Indicator */}
           <div className='absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 p-2 bg-white/20 rounded-xl border border-white/30 backdrop-2xl'>
            {items.map((_, i) => (
              <button
                key={i}
                onClick={() => setIndex(i)}
