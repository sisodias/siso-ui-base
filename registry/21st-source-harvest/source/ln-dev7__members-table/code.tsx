...
function MemberLine({ user }: MemberLineProps) {
   return (
      <div className="w-full flex items-center py-3 px-6 border-b hover:bg-sidebar/50 border-muted-foreground/5 text-sm last:border-b-0">
         ...
         <div className="w-32 shrink-0 hidden lg:block text-xs text-muted-foreground">
            {format(new Date(user.joinedDate), 'MMM yyyy')}
         </div>
         <div className="w-40 shrink-0 hidden md:flex text-xs text-muted-foreground">
...
export default function component() {
   return (
       <div className="w-full h-full bg-white dark:bg-black text-black dark:text-white transition-colors duration-300">
         <div className="bg-container px-6 py-1.5 text-sm flex items-center text-muted-foreground border-b sticky top-0 z-10">
            <div className="flex-grow">Name</div>
            <div className="w-32 shrink-0">Status</div>
            <div className="w-32 shrink-0 hidden lg:block">Joined</div>
            <div className="w-40 shrink-0 hidden md:block">Teams</div>
         </div>
