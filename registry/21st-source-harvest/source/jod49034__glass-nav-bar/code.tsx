      ...
      <div className="glass-container glass-container--rounded glass-container--medium">
        ...
        <div className="glass-content">
          <div className="glass-item glass-item--active">
            <svg viewBox="0 0 576 512" width="40" title="home" aria-hidden="true" focusable="false">
              <path
                fill="currentColor"
                d="M280.37 148.26L96 300.11V464a16 16 0 0 0 16 16l112.06-.29a16 16 0 0 0 15.92-16V368a16 16 0 0 1 16-16h64a16 16 0 0 1 16 16v95.64a16 16 0 0 0 16 16.05L464 480a16 16 0 0 0 16-16V300L295.67 148.26a12.19 12.19 0 0 0-15.3 0zM571.6 251.47L488 182.56V44.05a12 12 0 0 0-12-12h-56a12 12 0 0 0-12 12v72.61L318.47 43a48 48 0 0 0-61 0L4.34 251.47a12 12 0 0 0-1.6 16.9l25.5 31A12 12 0 0 0 45.15 301l235.22-193.74a12.19 12.19 0 0 1 15.3 0L530.9 301a12 12 0 0 0 16.9-1.6l25.5-31a12 12 0 0 0-1.7-16.93z"
              />
            </svg>
            <span className="glass-label">Home</span>
          </div>

          <div className="glass-item">
            <svg viewBox="0 0 512 512" width="30" title="layer-group" aria-hidden="true" focusable="false">
              <path
                fill="currentColor"
            ...
            <span className="glass-label">New</span>
          </div>

          <div className="glass-item">
            <svg viewBox="0 0 640 512" width="40" title="wifi" aria-hidden="true" focusable="false">
              <path
                fill="currentColor"
            ...
            <span className="glass-label">Wifi</span>
          </div>

          <div className="glass-item">
            <svg viewBox="0 0 512 512" width="30" title="music" aria-hidden="true" focusable="false">
              <path
                fill="currentColor"
                d="M470.38 1.51L150.41 96A32 32 0 0 0 128 126.51v261.41A139 139 0 0 0 96 384c-53 0-96 28.66-96 64s43 64 96 64 96-28.66 96-64V214.32l256-75v184.61a138.4 138.4 0 0 0-32-3.93c-53 0-96 28.66-96 64s43 64 96 64 96-28.65 96-64V32a32 32 0 0 0-41.62-30.49z"
              />
            </svg>
            <span className="glass-label">Library</span>
          </div>
        </div>
      </div>
    </div>
