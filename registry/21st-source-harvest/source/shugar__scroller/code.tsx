...
export const Scroller = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex ${overflow === "x" ? "flex-row" : "flex-col"} relative hide-scrollbar overflow-auto ${childrenContainerClassName || ""}`}
        ref={containerRef}
      ...
      <div className={`absolute ${showTopOverlay ? "top-0" : "-top-10"} left-0 right-0 w-full h-10 bg-gradient-to-b  from-white dark:from-black/75 to-white/0 duration-300`} />
      <div className={`absolute ${showBottomOverlay ? "bottom-0" : "-bottom-10"} left-0 right-0 w-full h-10 bg-gradient-to-t  from-white dark:from-black/75 to-white/0 duration-300`} />
      <div className={`absolute top-0 bottom-0 ${showLeftOverlay ? "left-0" : "-left-10"} w-10 h-full bg-gradient-to-r  from-white dark:from-black/75 to-white/0 duration-300`} />
      <div className={`absolute top-0 bottom-0 ${showRightOverlay ? "right-0" : "-right-10"} w-10 h-full bg-gradient-to-l  from-white dark:from-black/75 to-white/0 duration-300`} />
    </div>
  );
};