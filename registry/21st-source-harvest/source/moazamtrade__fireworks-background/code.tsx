...
function createFirework(
  ...
  return {
    ...
    update() {
      ...
      this.x += this.vx;
      this.y += this.vy;
      this.vy += 0.02; // gravity on the firework (slows ascent)
    ...
    explode() {
      ...
      for (let i = 0; i < numParticles; i++) {
        ...
        // Rainbow per-particle color:
        const particleColor = randColor();
...
export const FireworksBackground = React.forwardRef<HTMLDivElement, FireworksBackgroundProps>(
  function FireworksBackground(
    ...
    React.useEffect(() => {
      ...
      const launchFirework = () => {
        ...
        const timeout = rand(300, 800) / Math.max(population, 0.001);
      ...
      const handleClick = (event: MouseEvent) => {
        ...
        const x = event.clientX - rect.left; // align with canvas coords
        const y = maxY;
