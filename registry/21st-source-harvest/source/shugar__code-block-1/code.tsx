...
import { Option, Select } from "@/components/ui/select-1";
...
export const CodeBlock = ({
  ...
  return (
    <div className="rounded-md overflow-hidden border border-gray-400">
      {filename && (
        <div className="pl-4 pr-3 rounded-t-md border-b border-gray-400 h-12 flex items-center bg-background-200 fill-gray-900">
          <div className="flex items-center gap-2 text-[13px] mr-auto text-gray-900">
            ...
            <Button svgOnly type="tertiary" size="small" onClick={onClick}>
              <div className="h-4 w-4">
                <svg
                  ...
                  viewBox="0 0 16 16"
                  width="16"
                  className={`absolute top-0 left-1/2 -translate-x-1/2 z-10 fill-gray-900${animation ? " animate-fade-out" : ""}`}
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                ...
                <svg
                  ...
                  viewBox="0 0 16 16"
                  width="16"
                  className={`absolute top-0 left-1/2 -translate-x-1/2 opacity-0 fill-gray-900${animation ? " animate-fade-in" : ""}`}
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
