...
/* Source airport database from flightcn. */
...
type AirportRef = string | [number, number];
...
function resolveAirport(ref: AirportRef): [number, number] {
  ...
  if (!airport) {
    throw new Error(`Unknown airport code: "${ref}". Use a valid IATA code or pass [longitude, latitude] directly.`);
  }
...
export type { MapRef, MapViewport, AirportInfo, AirportRef, FlightAirportProps };
