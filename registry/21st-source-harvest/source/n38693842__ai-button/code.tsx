...
export function Component() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full">
      ...
      >
        <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-40% to-purple-500 px-4 py-2 text-white overflow-hidden">
          {/* Main Sparkle */}
          <motion.div
            animate={{
              opacity: [0.75, 1, 0.75],
        ...
        {/* Particle System */}
        <ParticleSystem isActive={isHovering} />
      </motion.button>
    </div>
  );
}