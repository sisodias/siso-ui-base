...
// popover-stage/src/lib/utils.ts
function cn(...c) {
  return c.flat().filter(Boolean).join(" ");
}

// popover-stage/src/components/ui/button.tsx
...
// popover-stage/src/components/ui/8bit/button.tsx
...
function Button2({ children, asChild, ...props }) {
  const { variant, size: size4, className, font } = props;
  return <Button
    {...props}
    className={cn(
  ...
  >
      {asChild ? <span className="relative inline-flex items-center justify-center gap-1.5">
          ...
          {variant !== "ghost" && variant !== "link" && size4 !== "icon" && <>
              {
    /* Pixelated border */
  }
...
// popover-stage/src/components/ui/input.tsx
...
// popover-stage/src/components/ui/8bit/input.tsx
...
// popover-stage/src/components/ui/label.tsx
...
// popover-stage/src/components/ui/8bit/label.tsx
...
// popover-stage/src/components/ui/popover.tsx
import * as React36 from "react";

// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@radix-ui/react-popover/dist/index.mjs
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@radix-ui/react-popper/dist/index.mjs
import * as React21 from "react";

// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@floating-ui/utils/dist/floating-ui.utils.mjs
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@floating-ui/core/dist/floating-ui.core.mjs
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@floating-ui/utils/dist/floating-ui.utils.dom.mjs
function hasWindow() {
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@floating-ui/dom/dist/floating-ui.dom.mjs
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.mjs
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@radix-ui/react-arrow/dist/index.mjs
...
var Arrow = React19.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx9(
    Primitive2.svg,
    {
      ...
      children: props.asChild ? children : /* @__PURE__ */ jsx9("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@radix-ui/react-use-size/dist/index.mjs
...
var Popper = (props) => {
  ...
  return /* @__PURE__ */ jsx10(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
...
var PopperAnchor = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : /* @__PURE__ */ jsx10(Primitive2.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React22.forwardRef((props, forwardedRef) => {
  const { container: containerProp, ...portalProps } = props;
  const [mounted, setMounted] = React22.useState(false);
  useLayoutEffect2(() => setMounted(true), []);
  const container = containerProp || mounted && globalThis?.document?.body;
  return container ? ReactDOM4.createPortal(/* @__PURE__ */ jsx11(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
// ../../../Users/dav/.claude/skills/21st-publish-from-registry/.workspace/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-slot/dist/index.mjs
import * as React25 from "react";
import { Fragment as Fragment23, jsx as jsx12 } from "react/jsx-runtime";
// @__NO_SIDE_EFFECTS__
function createSlot3(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx12(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Popover = (props) => {
  ...
  return /* @__PURE__ */ jsx13(Root22, { ...popperScope, children: /* @__PURE__ */ jsx13(
    PopoverProvider,
    {
...
var PopoverTrigger = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.hasCustomAnchor ? trigger : /* @__PURE__ */ jsx13(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx13(PortalProvider, { scope: __scopePopover, forceMount, children: /* @__PURE__ */ jsx13(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx13(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx13(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ jsx13(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsx13(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx13(Combination_default, { as: Slot2, allowPinchZoom: true, children: /* @__PURE__ */ jsx13(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope(__scopePopover);
    return /* @__PURE__ */ jsx13(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var PopoverContent2 = React36.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => <Portal2>
    <Content2
  ref={ref}
  align={align}
...
// popover-stage/src/components/ui/8bit/popover.tsx
var Popover3 = Popover2;
var PopoverTrigger3 = PopoverTrigger2;
var PopoverAnchor3 = PopoverAnchor2;
