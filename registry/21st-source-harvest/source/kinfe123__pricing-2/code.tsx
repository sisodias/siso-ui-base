    ...
    <div className="isolate relative overflow-hidden bg-transparent">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-2 text-4xl font-bold tracking-tight dark:text-white text-black sm:text-5xl font-geist md:leading-4">
            ...
            <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
                ...
                >
                  <div>
                    ...
                    <div className="mt-4 flex items-baseline gap-x-2">
                      <span className="text-5xl font-bold tracking-tight dark:text-gray-100">
                        {tier.priceMonthly}
                      </span>
                      <span className="text-base font-semibold leading-7 dark:text-gray-200 text-gray-800 ">
                        /month
                      </span>
                    </div>
                    ...
                    <ul
                      role="list"
                      className="mt-10 space-y-4 text-sm leading-6 text-gray-700 dark:text-gray-200"
                    >
              ...
              <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center  dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset]">
                <div className="lg:min-w-0 lg:flex-1">
                  ...
                  <p className="mt-1 text-base leading-7 text-gray-700 dark:text-gray-200">
