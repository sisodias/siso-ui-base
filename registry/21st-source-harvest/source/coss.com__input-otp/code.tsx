...
export function InputOTPSeparator({
  ...
  return (
    <div
      aria-hidden
      className={cn(
        "shrink-0 rounded-full bg-input h-0.5 w-3",
        className,
      )}
      role="separator"
      {...props}
