...
export default function ExcelViewer({
  ...
  const [internalIsDark, setInternalIsDark] = React.useState(isDark)
  const effectiveIsDark = onIsDarkChange ? isDark : internalIsDark
  ...
  return (
    <XlsxViewerPreview
      ...
      fileName={fileName}
      isDark={effectiveIsDark}
      onIsDarkChange={onIsDarkChange ?? setInternalIsDark}
      src={src}
    />
  )
}
